import {validateDatabaseUrl, validateRateLimitSecret} from '../lib/security/env';
...
function required(name: typeof REQUIRED[number]) {
...
function main() {
    ...
    validateRateLimitSecret(required('RATE_LIMIT_SECRET'));
