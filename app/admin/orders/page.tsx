      ...
      <div className="mx-auto w-full max-w-none">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between">
          ...
          <div className="grid grid-cols-2 gap-2 sm:flex sm:gap-3">
            ...
            <form
              action={logoutAllAdminSessions}
              className="col-span-2 grid sm:col-span-1"
            >
              <button
                type="submit"
        ...
        {orders.pageCount > 1 ? (
          <nav
            className="mt-4 grid grid-cols-2 items-center gap-3 sm:flex sm:justify-between"
          ...
          >
            ...
            <span className="order-first col-span-2 text-center text-sm text-stone-600 sm:order-none sm:col-span-1">
              Страница {orders.page} от {orders.pageCount} · {orders.total}{" "}
              заказа
            </span>
            <Link
